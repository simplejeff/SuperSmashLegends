 ...
 *
 */
public class StartGameBar extends UIElement {
  ...
  public StartGameBar(Vec2i startPoint) {
  ...
  public void drawElement(Graphics2D g) {
    ...
    g.drawString("Start Debugger", (int)(coords.x + sides.x * .2), (int)(coords.y + sides.y * .5));
