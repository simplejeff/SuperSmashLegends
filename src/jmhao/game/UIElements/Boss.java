...
public class Boss<T extends PhysicsEntity<T>> extends GamePhysicsEntity<T>{
  GameWorld<T> myGW;
  ...
  double reload = 0;
  public Boss(GameWorld<T> gw, Vec2i startPoint, int size, float velX) {
    myGW = gw;
    myHeight = size*2;
  ...
  public void doCollide(T e) {
    ((GamePhysicsEntity<T>)e).collideBoss(this);
  }
 /* @Override
