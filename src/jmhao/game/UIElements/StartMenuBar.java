 ...
 *
 */
public class StartMenuBar extends UIElement {
  ...
  public StartMenuBar(Vec2i startPoint) {
  ...
  public void drawElement(Graphics2D g) {
    ...
    g.drawString("Return to Menu", (int)(coords.x + sides.x * .2), (int)(coords.y + sides.y * .5));
