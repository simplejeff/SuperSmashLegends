...
public class BackgroundHoriz<T extends PhysicsEntity<T>> extends GamePhysicsEntity<T>{
  public BackgroundHoriz(Vec2f startLoc, float width, float length) {
  ...
  public void doCollide(T e) {
    ((GamePhysicsEntity<T>)e).collideHorizWall(this);
  }
  @Override
