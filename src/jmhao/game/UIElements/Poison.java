...
public class Poison<T extends PhysicsEntity<T>> extends GamePhysicsEntity<T>{
  Vec2f velocity;
  GameWorld<T> myGW;
  boolean playerOne;
  ...
  long totalMillis = 0;
  float totalTime = 450;
  public Poison(GameWorld<T> gw, Vec2i startPoint, Vec2f thisVelocity, boolean playerOne, int facing) {
    myGW = gw;
  ...
  public void drawElement(Graphics2D g) {
   // s.drawElement(g);
    Final.spriteTeemoQ.drawSprite(g, s.getLocation(), facing, moving);
  }
  ...
  public void doCollide(T e) {
    ((GamePhysicsEntity<T>)e).collidePoison(this);
  }
  @Override
