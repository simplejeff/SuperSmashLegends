...
public class TestPoly<T extends PhysicsEntity<T>> extends PhysicsEntity<T> {
  Polygon poly;
  boolean selected = false;
  Vec2f collisionVec;
  boolean colliding = false;
  public TestPoly(Vec2i startLoc, Vec2f...myPoints) {
    poly = new Polygon(startLoc, myPoints);
    setShape(poly);
  }
  @Override
